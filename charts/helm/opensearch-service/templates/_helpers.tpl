...
{{- define "opensearch.monitoredImages" -}}
  ...
  {{- printf "statefulset opensearch opensearch %s, " (include "opensearch.fullname" .) (index .Values.deployDescriptor "prod.platform.elasticstack_docker-opensearch" "image") -}}
  {{- end }}
  {{- if .Values.curator.enabled }}
