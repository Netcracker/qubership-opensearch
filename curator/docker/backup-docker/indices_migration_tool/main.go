...
var (
	...
	opensearchUsername           = common.GetSecretValue(common.OpenSearchMigrationSecretsDirEnv, "ES_USERNAME", "")
	opensearchPassword           = common.GetSecretValue(common.OpenSearchMigrationSecretsDirEnv, "ES_PASSWORD", "")
	adapterUsername              = common.GetSecretValue(common.OpenSearchMigrationSecretsDirEnv, "DBAAS_ADAPTER_USERNAME", "")
	adapterPassword              = common.GetSecretValue(common.OpenSearchMigrationSecretsDirEnv, "DBAAS_ADAPTER_PASSWORD", "")
	adapterAddress               = common.GetEnv("DBAAS_ADAPTER_ADDRESS", "")
	aggregatorAddress            = common.GetEnv("DBAAS_AGGREGATOR_REGISTRATION_ADDRESS", "")
	aggregatorUsername           = common.GetSecretValue(common.OpenSearchMigrationSecretsDirEnv, "DBAAS_AGGREGATOR_REGISTRATION_USERNAME", "")
	aggregatorPassword           = common.GetSecretValue(common.OpenSearchMigrationSecretsDirEnv, "DBAAS_AGGREGATOR_REGISTRATION_PASSWORD", "")
