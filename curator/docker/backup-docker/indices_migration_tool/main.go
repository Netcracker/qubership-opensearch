...
var (
	...
	opensearchUsername           = common.GetSecretValue(common.OpenSearchCuratorSecretsDirEnv, "ES_USERNAME", "")
	opensearchPassword           = common.GetSecretValue(common.OpenSearchCuratorSecretsDirEnv, "ES_PASSWORD", "")
	adapterUsername              = common.GetSecretValue(common.OpenSearchCuratorSecretsDirEnv, "DBAAS_ADAPTER_USERNAME", "")
	adapterPassword              = common.GetSecretValue(common.OpenSearchCuratorSecretsDirEnv, "DBAAS_ADAPTER_PASSWORD", "")
	adapterAddress               = common.GetEnv("DBAAS_ADAPTER_ADDRESS", "")
	aggregatorAddress            = common.GetEnv("DBAAS_AGGREGATOR_REGISTRATION_ADDRESS", "")
	aggregatorUsername           = common.GetSecretValue(common.OpenSearchCuratorSecretsDirEnv, "DBAAS_AGGREGATOR_REGISTRATION_USERNAME", "")
	aggregatorPassword           = common.GetSecretValue(common.OpenSearchCuratorSecretsDirEnv, "DBAAS_AGGREGATOR_REGISTRATION_PASSWORD", "")
