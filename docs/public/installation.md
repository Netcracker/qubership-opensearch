...
| `opensearch.master.resources.limits.cpu`               | string  | no        | 1000m                                                                                                        | The maximum number of CPUs the OpenSearch master node container should use.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `opensearch.arbiter.resources.limits.cpu`               | string  | no        | 1000m                                                                                                        | The maximum number of CPUs the OpenSearch arbiter node container should use.                                                                                                                                                                                                                                                |
...
| `opensearch.data.resources.limits.cpu`               | string  | no        | 1000m                                                                                                        | The maximum number of CPUs the OpenSearch data node container should use.                                                                                                                                                                                                                                                                                                                                          |
