...
| `opensearch.audit`                                            | object  | no        | {}                                                                 | The configuration of audit properties for OpenSearch (`audit.yml`). For more information, see [Settings in audit.yml](https://opensearch.org/docs/latest/security/audit-logs/index/#settings-in-audityml).                                                                                                             |
