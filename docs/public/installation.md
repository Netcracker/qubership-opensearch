...
| `integrationTests.atpStorage.provider`           | string  | no        | aws                      | S3 provider type: `aws` (AWS S3), `minio`, `s3` (S3-compatible with custom endpoint).                                                                                                                                                                                                                                                                        |
| `integrationTests.atpStorage.serverUrl`          | string  | no        | `https://s3.amazonaws.com` | S3 API server URL (for example `https://s3.amazonaws.com` or `https://minio.example.com`).                                                                                                                                                                                                                                                                |
| `integrationTests.atpStorage.serverUiUrl`        | string  | no        | ""                       | Optional S3 UI URL for browsing results.                                                                                                                                                                                                                                                                                                                   |
| `integrationTests.atpStorage.bucket`             | string  | no        | ""                       | S3 bucket name for uploaded artifacts. If empty, S3 integration is disabled.                                                                                                                                                                                                                                                                                |
| `integrationTests.atpStorage.region`             | string  | no        | us-east-1                | S3 region (required for AWS S3).                                                                                                                                                                                                                                                                                                                           |
| `integrationTests.atpStorage.username`           | string  | no        | ""                       | S3 access key/user. Used only when `integrationTests.atpReport.enabled=true` (passed via Kubernetes Secret).                                                                                                                                                                                                                                               |
| `integrationTests.atpStorage.password`           | string  | no        | ""                       | S3 secret key/password. Used only when `integrationTests.atpReport.enabled=true` (passed via Kubernetes Secret).                                                                                                                                                                                                                                           |
| `integrationTests.atpReport.enabled`             | boolean | no        | false                    | Explicit opt-in flag that enables upload behavior in shared `qubership-docker-integration-tests` scripts (maps to env `ATP_REPORT_ENABLED`).                                                                                                                                                                                                                |
| `integrationTests.atpReportViewUiUrl`            | string  | no        | ""                       | URL for viewing Allure reports (for example `https://reports.example.com`).                                                                                                                                                                                                                                                                                 |
