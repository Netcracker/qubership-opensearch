...
| `dashboards.envoyGateway.host`                       | string  | no        | ""                                                                           | Specifies the hostname used in the generated HTTPRoute for accessing OpenSearch Dashboards.                                                                                                                                                                                                                        |
...
| `opensearch.client.envoyGateway.enabled`               | boolean | no        | true                                                                                                        | Enables creation of a Gateway API HTTPRoute resource to expose the OpenSearch client through Envoy Gateway.                                                                                                                                                                                                                |
| `opensearch.client.envoyGateway.host`                  | string  | no        | ""                                                                                                          | Specifies the hostname used in the generated HTTPRoute for accessing the OpenSearch client API.                                                                                                                                                                                                                            |
