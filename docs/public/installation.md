...
| `opensearch.securityConfig.ldap.search.base`                  | string  | no        | ""                                                                | LDAP search base, for axemple `"DC=testad,DC=local"`                                                                                                                                                                                                                                                                   |
| `opensearch.securityConfig.ldap.search.filter`                | string  | no        | ""                                                                | LDAP search filter, for axemple `"(&(objectClass=user)(cn={0}))"`                                                                                                                                                                                                                                                      |
