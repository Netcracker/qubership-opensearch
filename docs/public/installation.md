...
| `dashboards.envoyGateway.parentRefs`                 | list    | no        | [{"name": "default-external-gateway", "namespace": "envoy-gateway"}]         | List of Gateway resources that the generated HTTPRoute for OpenSearch Dashboards will attach to.                                                                                                                                                                                                                   |
...
| `opensearch.client.envoyGateway.parentRefs`            | list    | no        | [{"name": "default-external-gateway", "namespace": "envoy-gateway"}]                                        | List of Gateway resources that the generated HTTPRoute for OpenSearch client will attach to.                                                                                                                                                                                                                               |
