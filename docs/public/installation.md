...
| `monitoring.serviceMonitor.clusterStateScrapeTimeout`  | string  | no        | 10s                      | The timeout of scrape metrics from the state metrics of the OpenSearch cluster endpoint.                                                                                                                                                                                                                                                                                                                                               |
