...
| `dashboards.envoyGateway.enabled`                    | boolean | no        | true                                                                         | Enables creation of a Gateway API HTTPRoute resource to expose OpenSearch Dashboards through Envoy Gateway.                                                                                                                                                                                                        |
