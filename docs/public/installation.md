...
| `curator.storage.enabled`                                  | boolean | no        | true                     | Whether a dedicated persistent volume is to be used for OpenSearch Curator snapshot storage. If set to `false`, the curator shares the OpenSearch snapshot PVC.                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `curator.storage.size`                                     | string  | no        | 5Gi                      | The size of the persistent volume for OpenSearch Curator snapshot storage.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `curator.storage.persistentVolume`                         | string  | no        | ""                       | The name of a pre-provisioned persistent volume to bind to the curator snapshot PVC. Used when dynamic provisioning is disabled.                                                                                                                                                                                                                                                                                                                                                                                                                                               |
