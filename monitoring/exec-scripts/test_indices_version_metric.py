...
from indices_version_metric import (
    _parse_version_created,
    _get_version_num,
    _collect_metrics,
)
...
class TestIndicesVersionMetric(unittest.TestCase):
    ...
    def test_collect_metrics_with_mixed_versions(self, mock_get_settings):
        ...
        self.assertIn(
            'opensearch_indices_version_created,version="1.3.17",version_num=10317,namespace="" count=2i',
            metrics,
        )
        self.assertIn(
            'opensearch_indices_version_created,version="2.11.1",version_num=21101,namespace="" count=1i',
            metrics,
        )
    ...
    def test_collect_metrics_handles_missing_version(self, mock_get_settings):
        ...
        mock_get_settings.return_value = {"index-1": {"settings": {"index": {}}}}
