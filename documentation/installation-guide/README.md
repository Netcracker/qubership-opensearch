...
| Parameter                                    | Type    | Mandatory | Default value | Description                                                                                                                                                                                                                                                                                                                           |
|----------------------------------------------|---------|-----------|---------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `global.clusterName`                         | string  | no        | opensearch    | The name of OpenSearch cluster.                                                                                                                                                                                                                                                                                                       |
| `global.psp.create`                          | boolean | no        | false         | Whether `PodSecurityPolicy` is to be created and used.                                                                                                                                                                                                                                                                                |
| `global.velero.preHookBackupEnabled`         | boolean | no        | true          | Whether Velero backup pre-hook with OpenSearch flush command is to be enabled. If parameter is set to `true`, OpenSearch initiates data flushing to store all `unflushed` data on disk before Velero backup procedure. For more information about Velero backup hooks, see [Backup Hooks](https://velero.io/docs/v1.9/backup-hooks/). |
...
| `global.securityContext`                     | object  | no        | {}            | The pod-level security attributes and common container settings for all pods that are related to the OpenSearch Service. These security context can be overridden by component `securityContext` parameter.                                                                                                                           |
| `global.tls.enabled`                         | boolean | no        | false         | Whether TLS is to be enabled for all OpenSearch services. For more information about TLS, see [Encrypted Access](/documentation/installation-guide/encrypted-access/README.md).                                                                                                                                                       |
...
| `global.tls.generateCerts.enabled`           | boolean | no        | true          | Whether TLS certificates are to be generated. This parameter is taken into account only if `global.tls.enabled` parameter is set to `true`.                                                                                                                                                                                           |
...
| `global.tls.generateCerts.clusterIssuerName` | string  | no        | ""            | The name of the `ClusterIssuer` resource. If the parameter is not set or empty, the `Issuer` resource is created in the current Kubernetes namespace. It is used when `global.tls.generateCerts.certProvider` parameter is set to `cert-manager`.                                                                                     |
...
| `global.externalOpensearch.username`         | string  | no        | ""            | The username of external OpenSearch user to connect. The user should have admin rights.                                                                                                                                                                                                                                               |
| `global.externalOpensearch.password`         | string  | no        | ""            | The password of external OpenSearch user to connect. The user should have admin rights.                                                                                                                                                                                                                                               |
...
| Parameter                                                                  | Type    | Mandatory | Default value            | Description                                                                                                                                                                                                                                                                    |
|----------------------------------------------------------------------------|---------|-----------|--------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `global.disasterRecovery.image`                                            | string  | no        | Calculates automatically | The image of OpenSearch Disaster Recovery container.                                                                                                                                                                                                                           |
| `global.disasterRecovery.tls.enabled`                                      | boolean | no        | true                     | Whether TLS is to be enabled for Disaster Recovery Daemon. This parameter is taken into account only if `global.tls.enabled` parameter is set to `true`. For more information about TLS, see [Encrypted Access](/documentation/installation-guide/encrypted-access/README.md). |
...
| `global.disasterRecovery.httpAuth.smServiceAccountName`                    | string  | no        | sm-auth-sa               | The name of Kubernetes service account that site manager is used.                                                                                                                                                                                                              |
| `global.disasterRecovery.httpAuth.restrictedEnvironment`                   | boolean | no        | false                    | Whether the `system:auth-delegator` cluster role is to be bound to OpenSearch operator service account.                                                                                                                                                                        |
| `global.disasterRecovery.mode`                                             | string  | no        | ""                       | The mode of OpenSearch disaster recovery installation. If you do not specify this parameter, the service is deployed in a regular mode, not Disaster Recovery mode. The possible values are `active`,`standby`,`disable`.                                                      |
...
| `global.disasterRecovery.remoteCluster`                                    | string  | no        | ""                       | The URL of `active` OpenSearch service. For example, `opensearch.opensearch-service.svc.cluster-2.local:9300`.                                                                                                                                                                 |
...
| `global.disasterRecovery.timeout`                                          | integer | no        | 600                      | The timeout for switchover.                                                                                                                                                                                                                                                    |
...
| `global.disasterRecovery.replicationWatcherEnabled`                        | boolean | no        | false                    | Whether Replication Watcher feature is to be enabled. It periodically checks that replication on the `standby` side is running correctly and restarts replication if something goes wrong.                                                                                     |
| `global.disasterRecovery.replicationWatcherIntervalSeconds`                | integer | no        | 30                       | The interval in seconds to check replication status by Replication Watcher.                                                                                                                                                                                                    |
| `global.disasterRecovery.serviceExport.enabled`                            | boolean | no        | false                    | Whether resource `net.gke.io/v1 ServiceExport` is to be created. It should be set to `true` only on GKE cluster with configured MCS. If it is enabled, the parameter `global.disasterRecovery.serviceExport.region` should be also specified.                                  |
| `global.disasterRecovery.serviceExport.region`                             | string  | no        | ""                       | The region of the cloud where current instance of OpenSearch service is installed. For example, `us-central`. It should be specified if `global.disasterRecovery.serviceExport.enabled` is set to `true`.                                                                      |
...
| `dashboards.imagePullPolicy`                         | string  | no        | Always                                                                       | The image pull policy for Dashboards container.                                                                                                                                                                                                                                                                   |
| `dashboards.imagePullSecrets`                        | list    | no        | []                                                                           | The list of references to secrets in the same namespace to use for pulling any of the images used by Dashboards container.                                                                                                                                                                                        |
...
| `dashboards.ingress.enabled`                         | boolean | no        | false                                                                        | Whether Dashboards ingress is to be enabled.                                                                                                                                                                                                                                                                      |
| `dashboards.ingress.annotations`                     | object  | no        | {}                                                                           | The annotations for Dashboards ingress.                                                                                                                                                                                                                                                                           |
| `dashboards.ingress.className`                       | string  | no        | ""                                                                           | The class name of Dashboards ingress.                                                                                                                                                                                                                                                                             |
| `dashboards.ingress.hosts`                           | list    | no        | [{"host": "chart-example.local", "paths": [{"path": "/"}]}]                  | The list of host names for Dashboards ingress.                                                                                                                                                                                                                                                                    |
| `dashboards.ingress.tls`                             | list    | no        | []                                                                           | The list of TLS configurations for Dashboards ingress.                                                                                                                                                                                                                                                            |
| `dashboards.service.type`                            | string  | no        | ClusterIP                                                                    | The type of Dashboards service.                                                                                                                                                                                                                                                                                   |
| `dashboards.service.port`                            | string  | no        | 5601                                                                         | The port that is used for Dashboards service.                                                                                                                                                                                                                                                                     |
| `dashboards.service.loadBalancerIP`                  | string  | no        | ""                                                                           | The load balancer IP that is used for Dashboards service.                                                                                                                                                                                                                                                         |
| `dashboards.service.nodePort`                        | string  | no        | ""                                                                           | The node port that is used for Dashboards service.                                                                                                                                                                                                                                                                |
| `dashboards.service.labels`                          | object  | no        | {}                                                                           | The labels that are to be specified on Dashboards service.                                                                                                                                                                                                                                                        |
| `dashboards.service.annotations`                     | object  | no        | {}                                                                           | The annotations that are to be specified on Dashboards service.                                                                                                                                                                                                                                                   |
| `dashboards.service.loadBalancerSourceRanges`        | list    | no        | []                                                                           | The client IPs for which traffic is not restricted through the cloud-provider load-balancer.                                                                                                                                                                                                                      |
| `dashboards.service.httpPortName`                    | string  | no        | http                                                                         | The name of HTTP port for Dashboards service.                                                                                                                                                                                                                                                                     |
| `dashboards.config`                                  | object  | no        | {}                                                                           | The configuration of Dashboards (`dashboards.yml`).                                                                                                                                                                                                                                                               |
| `dashboards.nodeSelector`                            | object  | no        | {}                                                                           | The selector that defines the nodes where the Dashboards pods are scheduled on.                                                                                                                                                                                                                                   |
| `dashboards.tolerations`                             | list    | no        | []                                                                           | The list of toleration policies for Dashboards pod in `JSON` format.                                                                                                                                                                                                                                              |
| `dashboards.affinity`                                | object  | no        | {}                                                                           | The affinity scheduling rules in `JSON` format.                                                                                                                                                                                                                                                                   |
...
| `dashboards.opensearchAccount.secret`                | string  | no        | ""                                                                           | The name of the secret with the Dashboards server user as configured in your `dashboards.yml`.                                                                                                                                                                                                                    |
| `dashboards.opensearchAccount.keyPassphrase.enabled` | boolean | no        | false                                                                        | Whether mounting in key passphrase for the `opensearchAccount` is to be enabled.                                                                                                                                                                                                                                  |
| `dashboards.labels`                                  | object  | no        | {}                                                                           | The labels that are to be specified on Dashboards pod.                                                                                                                                                                                                                                                            |
| `dashboards.hostAliases`                             | list    | no        | []                                                                           | The list of hosts and IPs that will be injected into the Dashboards pod's hosts file.                                                                                                                                                                                                                             |
| `dashboards.serverHost`                              | string  | no        | 0.0.0.0                                                                      | The host of Dashboards server.                                                                                                                                                                                                                                                                                    |
| `dashboards.serviceAccount.create`                   | boolean | no        | true                                                                         | Whether the default service account for Dashboards is to be created.                                                                                                                                                                                                                                              |
| `dashboards.serviceAccount.name`                     | string  | no        | ""                                                                           | The name for Dashboards service account. If it is empty and `dashboards.serviceAccount.create` parameter is set to `true`, a name is generated using the fullname template.                                                                                                                                       |
| `dashboards.podAnnotations`                          | object  | no        | {}                                                                           | The annotations for Dashboards pod.                                                                                                                                                                                                                                                                               |
| `dashboards.podSecurityContext`                      | object  | no        | {}                                                                           | The pod-level security attributes and common container settings for Dashboards pod.                                                                                                                                                                                                                               |
| `dashboards.securityContext`                         | object  | no        | {"capabilities": {"drop": ["ALL"]}, "runAsNonRoot": true, "runAsUser": 1000} | The container-level security attributes and common container settings for Dashboards container.                                                                                                                                                                                                                   |
...
| `operator.resources.limits.memory`   | string  | no        | 128Mi                    | The maximum amount of memory the operator container should use use.                                      |

## OpenSearch

| Parameter                                                     | Type    | Mandatory | Default value                                                     | Description                                                                                                                                                                                                                                                                                                          |
|---------------------------------------------------------------|---------|-----------|-------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `opensearch.discoveryOverride`                                | string  | no        | ""                                                                | The possibility to override `discovery.seed_hosts` environment variable that allows second aliased deployment to find cluster.                                                                                                                                                                                       |
| `opensearch.compatibilityModeEnabled`                         | boolean | no        | true                                                              | Whether compatibility mode is to be enabled.                                                                                                                                                                                                                                                                         |
| `opensearch.gcLoggingEnabled`                                 | boolean | no        | false                                                             | Whether garbage collection logging is to be enabled for OpenSearch.                                                                                                                                                                                                                                                  |
| `opensearch.performanceAnalyzerEnabled`                       | boolean | no        | true                                                              | Whether OpenSearch Performance Analyzer plugin is to be running.                                                                                                                                                                                                                                                     |
| `opensearch.securityConfig.enabled`                           | boolean | no        | true                                                              | Whether custom [security configs](https://github.com/opensearch-project/security/tree/main/securityconfig) are to be used.                                                                                                                                                                                           |
...
| `opensearch.securityConfig.authc.basic.password`              | string  | yes       | ""                                                                | The password of the OpenSearch user with `admin` privileges. This value must not contain only digits.                                                                                                                                                                                                                |
...
| `opensearch.securityConfig.authc.oidc.roles_key`              | string  | no        | preferred_username                                                | The key in the JSON payload that stores the user’s roles. The value of this key must be a comma-separated list of roles. Required only if you want to use roles in the JWT.                                                                                                                                          |
| `opensearch.securityConfig.actionGroupsSecret`                | string  | no        | ""                                                                | The name of the secret with [action_groups.yml](https://github.com/opensearch-project/security/tree/main/securityconfig/action_groups.yml) configuration.                                                                                                                                                            |
| `opensearch.securityConfig.configSecret`                      | string  | no        | ""                                                                | The name of the secret with [config.yml](https://github.com/opensearch-project/security/tree/main/securityconfig/config.yml) configuration.                                                                                                                                                                          |
| `opensearch.securityConfig.internalUsersSecret`               | string  | no        | ""                                                                | The name of the secret with [internal_users.yml](https://github.com/opensearch-project/security/tree/main/securityconfig/internal_users.yml) configuration.                                                                                                                                                          |
| `opensearch.securityConfig.rolesSecret`                       | string  | no        | ""                                                                | The name of the secret with [roles.yml](https://github.com/opensearch-project/security/tree/main/securityconfig/roles.yml) configuration.                                                                                                                                                                            |
| `opensearch.securityConfig.rolesMappingSecret`                | string  | no        | ""                                                                | The name of the secret with [roles_mapping.yml](https://github.com/opensearch-project/security/tree/main/securityconfig/roles_mapping.yml) configuration.                                                                                                                                                            |
| `opensearch.securityConfig.tenantsSecret`                     | string  | no        | ""                                                                | The name of the secret with [tenants.yml](https://github.com/opensearch-project/security/tree/main/securityconfig/tenants.yml) configuration.                                                                                                                                                                        |
| `opensearch.securityConfig.config.securityConfigSecret`       | string  | no        | ""                                                                | The name of the secret for security configuration.                                                                                                                                                                                                                                                                   |
| `opensearch.securityConfig.config.data`                       | object  | no        | {}                                                                | The security configuration for OpenSearch in JSON format.                                                                                                                                                                                                                                                            |
| `opensearch.securityContextCustom`                            | object  | no        | {}                                                                | The pod-level security attributes and common container settings for the OpenSearch pods.                                                                                                                                                                                                                             |
...
| `opensearch.sysctl.enabled`                                   | boolean | no        | false                                                             | Whether `initContainer` to set `sysctl` to `vm.max_map_count` is to be enabled. This operation requires permissions to run `privileged` containers. The information about such permissions you can find in [Deployment Permissions](#deployment-permissions) section.                                                |
| `opensearch.fixmount.enabled`                                 | boolean | no        | false                                                             | Whether `initContainer` to fix mount permissions is to be enabled. It is not required if you set `fsGroup` via `securityContext`. This operation requires permissions to run `privileged` actions. The information about such permissions you can find in [Deployment Permissions](#deployment-permissions) section. |
...
| `opensearch.tls.enabled`                                      | boolean | no        | true                                                              | Whether TLS is to be enabled for REST layer of OpenSearch. This parameter must be set to `true` because OpenSearch does not support REST layer without encryption. For more information about TLS, see [Encrypted Access](/documentation/installation-guide/encrypted-access/README.md).                             |
| `opensearch.tls.cipherSuites`                                 | list    | no        | []                                                                | The list of cipher suites that are used to negotiate the security settings for a network connection using TLS or SSL network protocol. If this parameter is not specified, cipher suites are taken from `global.tls.cipherSuites` parameter.                                                                         |
| `opensearch.tls.generateCerts.enabled`                        | boolean | no        | true                                                              | Whether OpenSearch certificates are to be generated. This parameter is taken into account only if `global.tls.generateCerts.enabled` parameter is set to `true`.                                                                                                                                                     |
| `opensearch.tls.subjectAlternativeName.additionalDnsNames`    | list    | no        | []                                                                | The list of additional DNS names to be added to the `Subject Alternative Name` field of REST TLS certificate for OpenSearch.                                                                                                                                                                                         |
| `opensearch.tls.subjectAlternativeName.additionalIpAddresses` | list    | no        | []                                                                | The list of additional IP addresses to be added to the `Subject Alternative Name` field of REST TLS certificate for OpenSearch.                                                                                                                                                                                      |
| `opensearch.tls.transport.existingCertSecret`                 | string  | no        | ""                                                                | The name of the secret that contains the transport certificates. If the value is not specified, the secret with transport certificates named `<fullname>-transport-certs` is created, where `<fullname>` is OpenSearch full name.                                                                                    |
| `opensearch.tls.transport.existingCertSecretCertSubPath`      | string  | no        | tls.crt                                                           | The sub-path of `certificate` in OpenSearch transport certificates secret. This parameter is not taken into account if `opensearch.tls.transport.existingCertSecret` parameter is empty.                                                                                                                             |
| `opensearch.tls.transport.existingCertSecretKeySubPath`       | string  | no        | tls.key                                                           | The sub-path of `key` in OpenSearch transport certificates secret. This parameter is not taken into account if `opensearch.tls.transport.existingCertSecret` parameter is empty.                                                                                                                                     |
| `opensearch.tls.transport.existingCertSecretRootCASubPath`    | string  | no        | ca.crt                                                            | The sub-path of `root ca` in OpenSearch transport certificates secret. This parameter is not taken into account if `opensearch.tls.transport.existingCertSecret` parameter is empty.                                                                                                                                 |
| `opensearch.tls.rest.existingCertSecret`                      | string  | no        | ""                                                                | The name of the secret that contains the OpenSearch REST certificates. If the value is not specified, the secret with admin certificates named `<fullname>-rest-certs` is created, where `<fullname>` is OpenSearch full name.                                                                                       |
| `opensearch.tls.rest.existingCertSecretCertSubPath`           | string  | no        | tls.crt                                                           | The sub-path of `certificate` in OpenSearch REST certificates secret.                                                                                                                                                                                                                                                |
| `opensearch.tls.rest.existingCertSecretKeySubPath`            | string  | no        | tls.key                                                           | The sub-path of `key` in OpenSearch REST certificates secret.                                                                                                                                                                                                                                                        |
| `opensearch.tls.rest.existingCertSecretRootCASubPath`         | string  | no        | ca.crt                                                            | The sub-path of `root ca` in OpenSearch REST certificates secret.                                                                                                                                                                                                                                                    |
| `opensearch.tls.admin.existingCertSecret`                     | string  | no        | ""                                                                | The name of the secret that contains the admin users OpenSearch certificates. If the value is not specified, the secret with admin certificates named `<fullname>-admin-certs` is created, where `<fullname>` is OpenSearch full name.                                                                               |
| `opensearch.tls.admin.existingCertSecretCertSubPath`          | string  | no        | tls.crt                                                           | The sub-path of `certificate` in OpenSearch admin certificates secret.                                                                                                                                                                                                                                               |
| `opensearch.tls.admin.existingCertSecretKeySubPath`           | string  | no        | tls.key                                                           | The sub-path of `key` in OpenSearch admin certificates secret.                                                                                                                                                                                                                                                       |
| `opensearch.tls.admin.existingCertSecretRootCASubPath`        | string  | no        | ca.crt                                                            | The sub-path of `root ca` in OpenSearch admin certificates secret.                                                                                                                                                                                                                                                   |
...
| `opensearch.config`                                           | object  | no        | See in [values.yaml](/charts/helm/opensearch-service/values.yaml) | The configuration of common properties for OpenSearch (`opensearch.yml`). For more information, see [Modifying the YAML files](https://opensearch.org/docs/latest/security/configuration/yaml/#opensearchyml).                                                                                                       | `{}`                                                                                                    | false                                                                                            |
| `opensearch.log4jConfig`                                      | object  | no        | {}                                                                | The configuration of `log4j` properties for OpenSearch (`log4j2.properties`).                                                                                                                                                                                                                                        | `""`                                                                                                    | false                                            |
| `opensearch.loggingConfig`                                    | object  | no        | See in [values.yaml](/charts/helm/opensearch-service/values.yaml) | The configuration of logging properties for OpenSearch (`logging.yml`).                                                                                                                                                                                                                                              | see `values.yaml` for defaults                                                                          | false                                            |
| `opensearch.transportKeyPassphrase.enabled`                   | boolean | no        | false                                                             | Whether OpenSearch transport key passphrase is required.                                                                                                                                                                                                                                                             | `false`                                                                                                 | false                                            |
| `opensearch.transportKeyPassphrase.passPhrase`                | string  | no        | ""                                                                | The transport key passphrase for OpenSearch.                                                                                                                                                                                                                                                                         | `""`                                                                                                    | false                                            |
| `opensearch.sslKeyPassphrase.enabled`                         | boolean | no        | false                                                             | Whether OpenSearch SSL key passphrase is required.                                                                                                                                                                                                                                                                   | `false`                                                                                                 | false                                            |
| `opensearch.sslKeyPassphrase.passPhrase`                      | string  | no        | ""                                                                | The SSL key passphrase for OpenSearch.                                                                                                                                                                                                                                                                               | `""`                                                                                                    | false                                            |
| `opensearch.maxMapCount`                                      | integer | no        | 262144                                                            | The value of `max_map_count` for OpenSearch.                                                                                                                                                                                                                                                                         | `262144`                         | false                                            |
| `opensearch.dockerImage`                                      | string  | no        | Calculates automatically                                          | The docker image of OpenSearch.                                                                                                                                                                                                                                                                                      | `artifactorycn.netcracker.com:17008/product/prod.platform.elasticstack_docker-opensearch:master_latest` | false                                            |
| `opensearch.imagePullPolicy`                                  | string  | no        | Always                                                            | The image pull policy for OpenSearch containers. The possible values are `Always`, `IfNotPresent` or `Never`.                                                                                                                                                                                                        | `Always`                         | false                                            |
| `opensearch.configDirectory`                                  | string  | no        | /usr/share/opensearch/config                                      | The location of OpenSearch configuration.                                                                                                                                                                                                                                                                            | `"/usr/share/opensearch/config"` | false                                            |
| `opensearch.serviceAccount.create`                            | boolean | no        | true                                                              | Whether default service account for OpenSearch is to be created and used.                                                                                                                                                                                                                                            | `true`    | false                                            |
| `opensearch.serviceAccount.name`                              | string  | no        | ""                                                                | The name of the OpenSearch service account.                                                                                                                                                                                                                                                                          | `""`      | false                                            |
...
| `opensearch.master.updateStrategy`                     | string  | no        | RollingUpdate                                                                                               | The strategy used to replace old pods by new ones. The possible values are `OnDelete` and `RollingUpdate`.                                                                                                                                         |
...
| `opensearch.data.updateStrategy`                     | string  | no        | RollingUpdate                                                                                               | The strategy used to replace old pods by new ones. The possible values are `OnDelete` and `RollingUpdate`.                                                                                                                                     |
...
| `opensearch.snapshots.s3.region`             | string  | no        | ""            | The region in the S3 storage.                                                                                                                                                                                                                                                                                                                                          |
...
| `curator.tls.enabled`                                      | boolean | no        | true                     | Whether TLS is to be enabled for OpenSearch Curator. This parameter is taken into account only if `global.tls.enabled` parameter is set to `true`. For more information about TLS, see [Encrypted Access](/documentation/installation-guide/encrypted-access/README.md).                                                                                                                                                                                                                                                                                                        |
...
| `statusProvisioner.podReadinessTimeout`       | integer | no        | 600                      | The timeout in seconds that the job waits for the monitored resources to be ready or completed.                                                                                                                                                                                                                                                                                                                                                                             |
...
| `integrationTests.statusWritingEnabled`          | boolean | no        | true                     | Whether the status of OpenSearch integration tests execution is to be writen to deployment.                                                                                                                         |
...
| `integrationTests.tags`                          | string  | no        | smoke                    | The tags combined with `AND`, `OR` and `NOT` operators that select test cases to run. Information about available tags can be found in the [Integration test tags description](#tags-description) article.          |
...
| `integrationTests.prometheusUrl`                 | string  | no        | ""                       | The URL (with schema and port) to Prometheus. For example, `http://prometheus.cloud.openshift.sdntest.example.com:80`. This parameter must be specified if you want to run integration tests with `prometheus` tag. |
...
See [OpenSearch Disaster Recovery](/documentation/installation-guide/disaster-recovery/README.md) guide.
