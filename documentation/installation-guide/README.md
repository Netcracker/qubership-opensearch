...
| `global.disasterRecovery.replicationWatcherEnabled`                        | boolean | no        | true                     | Whether Replication Watcher feature is to be enabled. It periodically checks that replication on the `standby` side is running correctly and restarts replication if something goes wrong.                                                                                     |
