...
| `global.externalOpensearch.username`         | string  | no        | ""            | The username of external OpenSearch user to connect. The user must have full permissions to the cluster and manage roles and role mappings.                                                                                                                                                                                           |
| `global.externalOpensearch.password`         | string  | no        | ""            | The password of external OpenSearch user to connect. The user must have full permissions to the cluster and manage roles and role mappings.                                                                                                                                                                                           |
...
| `opensearch.serviceAccount.create`                            | boolean | no        | true                                                              | Whether default service account for OpenSearch is to be created and used.                                                                                                                                                                                                                                            |
