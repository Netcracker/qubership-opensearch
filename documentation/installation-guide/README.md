...
| `opensearch.tls.enabled`                                      | boolean | no        | true                                                              | Whether TLS is to be enabled for REST layer of OpenSearch. This parameter must be set to `true` because OpenSearch does not support REST layer without encryption. For more information about TLS, refer to the [TLS Encryption](/documentation/installation-guide/encrypted-access/README.md) section.                             |
