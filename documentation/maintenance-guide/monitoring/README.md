...
| opensearch_transport_rx_size_in_bytes                        | The size of received packages (in bytes) by OpenSearch nodes                                                                                                                                                                                                                                     | Supported     | Supported                     |
| opensearch_transport_server_open                             | The number of open transport connections on OpenSearch nodes                                                                                                                                                                                                                                     | Supported     | Supported                     |
| opensearch_transport_tx_size_in_bytes                        | The size of transmitted packages (in bytes) by OpenSearch nodes                                                                                                                                                                                                                                  | Supported     | Supported                     |
