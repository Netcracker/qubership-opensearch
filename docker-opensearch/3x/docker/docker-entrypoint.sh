...
"${OPENSEARCH_HOME}"/bin/opensearch-plugin install \
    --batch --verbose "file://${OPENSEARCH_HOME}/dist/repository-s3/repository-s3-3.5.0.zip"
"${OPENSEARCH_HOME}"/bin/opensearch-plugin install \
    --batch --verbose "file://${OPENSEARCH_HOME}/dist/repository-gcs/repository-gcs-3.5.0.zip"
